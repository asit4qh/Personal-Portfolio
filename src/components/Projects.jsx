...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      liveLink: 'https://dreamspos.netlify.app/',
      points: [
            ...
            <div className="flex flex-wrap justify-between items-start gap-4 mb-5">
              ...
              {proj.liveLink !== '#' && (
                <a 
                  ...
                  className="flex items-center gap-1.5 text-xs font-semibold text-cyan-400 bg-cyan-400/10 hover:bg-cyan-400/20 px-3 py-1.5 rounded-full transition-colors border border-cyan-400/20 shrink-0"
                >
                  Live Link
